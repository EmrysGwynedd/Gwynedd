# =============================================================
# AUTOMATED .NET 6 CLEAN REMOVAL + .NET 8.0.20 INSTALL SCRIPT
# Using dotnet-core-uninstall.msi (official Microsoft tool)
# =============================================================

Write-Host "`n=== STEP 1: Ensure .NET Uninstall Tool is Installed ===`n"

$uninstallToolPath = "C:\Program Files\dotnet-core-uninstall\dotnet-core-uninstall.exe"
$githubUrl = "https://github.com/dotnet/cli-lab/releases/latest/download/dotnet-core-uninstall-win-x64.msi"
$msiPath = "$env:TEMP\dotnet-core-uninstall.msi"

if (-Not (Test-Path $uninstallToolPath)) {
    Write-Host "Downloading dotnet-core-uninstall.msi ..."
    Invoke-WebRequest -Uri $githubUrl -OutFile $msiPath -UseBasicParsing
...
# Using Microsoft’s documented commands
# =============================================================
...
# =============================================================
# STEP 3: DELETE LEFTOVER DOTNET 6 FOLDER STRUCTURES
# =============================================================
...
Write-Host "`n=== STEP 4: Checking .NET 8.0.20 presence ===`n"
...
Write-Host "`n=== STEP 5: FINAL VERIFICATION ===`n"
