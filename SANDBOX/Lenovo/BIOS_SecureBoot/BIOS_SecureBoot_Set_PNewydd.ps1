...
# Mae angen rhedeg y script efo dau password gwahanol (hen a newydd).
# PEIDIWCH RHEDEG Y SGRIPT DROSODD A DROSODD! Neu, mi fydd password incorrect ymddangos arol reboot.
