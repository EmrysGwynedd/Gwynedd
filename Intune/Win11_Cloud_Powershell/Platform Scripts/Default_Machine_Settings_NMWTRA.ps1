# This script copies and Sets Machine Level Files and Preferences for NMWTRA Machine Profile. 
#
...
$files = @(
    ...
    @{url = "https://systemau.cyngor.gwynedd.llyw.cymru/Desgfwrdd/Desktop_Backgrounds/NMWTRA/Cefndir.png"; output = "C:\Windows\Wallpaper\Cefndir.png"},
    @{url = "https://systemau.cyngor.gwynedd.llyw.cymru/Desgfwrdd/Desktop_Backgrounds/NMWTRA/CefndirLock.png"; output = "C:\Windows\Web\Screen\CefndirLock.png"},
    ...
    @{url = "https://systemau.cyngor.gwynedd.llyw.cymru/Desgfwrdd/General_Files/Default_User_Settings_First_Logon_NMWTRA.ps1.txt"; output = "C:\Windows\Initialization\Initialize_User.ps1"},
...
$Regs = @(
    ...
    #@{RKey = "HKLM:\DEFUSER\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce"; RName = "Lenovo Driver Updates"; RVal = "C:\Program Files\Lenovo\SUHelper\SUHelper.exe -autoupdate"; RType="String"},
    ...
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1"; RName = "1400"; RVal = "3"; RType="DWORD"},
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1"; RName = "1402"; RVal = "3"; RType="DWORD"},
    ...
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1"; RName = "1803"; RVal = "3"; RType="DWORD"},
    ...
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2"; RName = "1400"; RVal = "3"; RType="DWORD"},
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2"; RName = "1402"; RVal = "3"; RType="DWORD"},
    ...
    @{RKey = "HKLM:\DEFUSER\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2"; RName = "1803"; RVal = "3"; RType="DWORD"},
